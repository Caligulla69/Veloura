...
import { Minus, Plus, X, ShoppingBag, ArrowRight, Shield, Truck, Heart, Gift } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-6">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 font-light">{cartItems.length} items in your cart</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cartItems.map((item) => (
              <div key={item.id} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 hover:bg-white/10 transition-all duration-300">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-white font-medium text-lg pr-8">{item.name}</h3>
                      <button 
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        <span className="text-white/60 text-sm font-light">Qty:</span>
            ...
            {cartItems.length === 0 && (
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-12 text-center">
                ...
                <h3 className="text-white text-xl font-light mb-2">Your cart is empty</h3>
                <p className="text-white/60 font-light mb-6">Add some items to get started</p>
                <Link to="/prodListing" className="bg-white text-black py-3 px-6 rounded-2xl font-medium hover:bg-gray-100 transition-all duration-300">
                  Continue Shopping
                </Link>
              </div>
            )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-12 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <svg className="w-8 h-5" viewBox="0 0 40 24" fill="none">
                      ...
                      <path d="M16.7 7.2L14.8 16.8H12.6L14.5 7.2H16.7Z" fill="#1A1F71"/>
                      <path d="M23.4 7.4C22.9 7.2 22.1 7 21.1 7C18.9 7 17.4 8.1 17.4 9.7C17.4 10.9 18.5 11.6 19.3 12C20.1 12.4 20.4 12.7 20.4 13.1C20.4 13.7 19.7 14 19.1 14C18.2 14 17.7 13.8 17 13.5L16.7 13.4L16.4 15.2C16.9 15.4 17.8 15.6 18.7 15.6C21.1 15.6 22.5 14.5 22.5 12.8C22.5 11.9 21.9 11.2 20.6 10.6C19.9 10.2 19.5 9.9 19.5 9.5C19.5 9.1 20 8.7 20.9 8.7C21.7 8.7 22.3 8.9 22.7 9.1L22.9 9.2L23.4 7.4Z" fill="#1A1F71"/>
                    </svg>
                  </div>
                  ...
                  <div className="w-12 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                    <svg className="w-8 h-5" viewBox="0 0 40 24" fill="none">
                      ...
                      <path d="M20 6.5C21.5 7.9 22.5 9.8 22.5 12C22.5 14.2 21.5 16.1 20 17.5C18.5 16.1 17.5 14.2 17.5 12C17.5 9.8 18.5 7.9 20 6.5Z" fill="#FF5F00"/>
                    </svg>
                  </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/80 text-sm font-light">Free shipping on orders $100+</p>
                    <p className="text-white/50 text-xs font-light">Estimated delivery: 2-3 business days</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/80 text-sm font-light">Gift wrapping available</p>
                    <p className="text-white/50 text-xs font-light">Add at checkout for $4.99</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/80 text-sm font-light">30-day easy returns</p>
                    <p className="text-white/50 text-xs font-light">Free return shipping</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          <Link to="/prodListing" className="text-white/70 hover:text-white font-light underline underline-offset-4 transition-colors flex items-center gap-2 mx-auto">
